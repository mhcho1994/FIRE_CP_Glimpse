package pendulumExample
    // Source: micahkc/cp_reach@c7f2e47:examples/basic/modelica_models/pendulumPID2.mo
    // Modified minimally for sanity check of the tool
    ...
    input Real d "Additive disturbance torque";
