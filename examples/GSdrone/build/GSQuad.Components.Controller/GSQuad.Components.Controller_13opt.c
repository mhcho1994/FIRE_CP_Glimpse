...
extern "C" {
#endif
int GSQuad_Components_Controller_mayer(DATA* data, modelica_real** res,short *i) {
...
int GSQuad_Components_Controller_lagrange(DATA* data, modelica_real** res, short * i1, short*i2) {
  throwStreamPrint(NULL, "The model was not compiled with -g=Optimica and the corresponding goal function. The optimization solver cannot be used.");
  return 0;
}
