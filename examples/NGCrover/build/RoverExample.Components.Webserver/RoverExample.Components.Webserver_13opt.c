...
extern "C" {
#endif
int RoverExample_Components_Webserver_mayer(DATA* data, modelica_real** res,short *i) {
...
int RoverExample_Components_Webserver_lagrange(DATA* data, modelica_real** res, short * i1, short*i2) {
  throwStreamPrint(NULL, "The model was not compiled with -g=Optimica and the corresponding goal function. The optimization solver cannot be used.");
  return 0;
}
int RoverExample_Components_Webserver_getInputVarIndicesInOptimization(DATA* data, int* input_var_indices) {
  throwStreamPrint(NULL, "The model was not compiled with -g=Optimica and the corresponding goal function. The optimization solver cannot be used.");
  return 0;
}
