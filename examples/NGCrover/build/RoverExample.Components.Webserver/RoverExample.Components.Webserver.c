...
void RoverExample_Components_Webserver_eqFunction_3(DATA *data, threadData_t *threadData)
{
  ...
  tmp0 = LessEq((data->localData[0]->integerVars[data->simulationInfo->integerVarsIndex[0]] /* timer_count DISCRETE */),(data->simulationInfo->integerParameter[data->simulationInfo->integerParamsIndex[1]] /* turn_interval_count PARAM */));
  ...
  {
    tmp2 = LessEq((data->localData[0]->integerVars[data->simulationInfo->integerVarsIndex[0]] /* timer_count DISCRETE */),(((modelica_integer) 2)) * ((data->simulationInfo->integerParameter[data->simulationInfo->integerParamsIndex[1]] /* turn_interval_count PARAM */)));
    tmp3 = Greater((data->localData[0]->integerVars[data->simulationInfo->integerVarsIndex[0]] /* timer_count DISCRETE */),(data->simulationInfo->integerParameter[data->simulationInfo->integerParamsIndex[1]] /* turn_interval_count PARAM */));
    if((tmp2 && tmp3))
    {
    ...
    {
      tmp4 = LessEq((data->localData[0]->integerVars[data->simulationInfo->integerVarsIndex[0]] /* timer_count DISCRETE */),(((modelica_integer) 3)) * ((data->simulationInfo->integerParameter[data->simulationInfo->integerParamsIndex[1]] /* turn_interval_count PARAM */)));
      tmp5 = Greater((data->localData[0]->integerVars[data->simulationInfo->integerVarsIndex[0]] /* timer_count DISCRETE */),(((modelica_integer) 2)) * ((data->simulationInfo->integerParameter[data->simulationInfo->integerParamsIndex[1]] /* turn_interval_count PARAM */)));
      if((tmp4 && tmp5))
      {
        (data->localData[0]->integerVars[data->simulationInfo->integerVarsIndex[1]] /* turn DISCRETE */) = ((modelica_integer) 1);
      }
  ...
  tmp6 = GreaterEq((data->localData[0]->integerVars[data->simulationInfo->integerVarsIndex[0]] /* timer_count DISCRETE */),(data->simulationInfo->integerParameter[data->simulationInfo->integerParamsIndex[0]] /* repeat_interval_count PARAM */));
  if(tmp6)
  {
...
struct OpenModelicaGeneratedFunctionCallbacks RoverExample_Components_Webserver_callback = {
  ...
  RoverExample_Components_Webserver_getInputVarIndicesInOptimization,
...
#define _OMC_LIT_RESOURCE_0_dir_data "/home/mhcho/ws/FIRE_CP_Glimpse/examples/NGCrover/model"
...
void RoverExample_Components_Webserver_setupDataStruc(DATA *data, threadData_t *threadData)
{
  ...
  data->modelData->modelGUID = "{94efe7d2-25c2-4beb-9ed1-b97eca8f0388}";
  ...
  data->modelData->nAliasIntegerArray = 1;
