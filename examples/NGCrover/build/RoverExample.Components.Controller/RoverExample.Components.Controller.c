...
int RoverExample_Components_Controller_input_function(DATA *data, threadData_t *threadData)
{
  ...
  (data->localData[0]->integerVars[data->simulationInfo->integerVarsIndex[3]] /* turn variable */) = data->simulationInfo->inputVars[12];
  (data->localData[0]->realVars[data->simulationInfo->realVarsIndex[12]] /* x variable */) = data->simulationInfo->inputVars[13];
  (data->localData[0]->realVars[data->simulationInfo->realVarsIndex[13]] /* y variable */) = data->simulationInfo->inputVars[14];
...
int RoverExample_Components_Controller_input_function_init(DATA *data, threadData_t *threadData)
{
  ...
  data->simulationInfo->inputVars[12] = data->modelData->integerVarsData[3].attribute.start;
  ...
  data->simulationInfo->inputVars[13] = real_get(data->modelData->realVarsData[12].attribute.start, 0);
  ...
  data->simulationInfo->inputVars[14] = real_get(data->modelData->realVarsData[13].attribute.start, 0);
...
int RoverExample_Components_Controller_input_function_updateStartValues(DATA *data, threadData_t *threadData)
{
  ...
  data->modelData->integerVarsData[3].attribute.start = data->simulationInfo->inputVars[12];
  assertStreamPrint(threadData, data->modelData->realVarsData[12].dimension.numberOfDimensions == 0, "Handling of array variables not yet implemetned.");
  put_real_element(data->simulationInfo->inputVars[13], 0, &data->modelData->realVarsData[12].attribute.start);
  assertStreamPrint(threadData, data->modelData->realVarsData[13].dimension.numberOfDimensions == 0, "Handling of array variables not yet implemetned.");
  put_real_element(data->simulationInfo->inputVars[14], 0, &data->modelData->realVarsData[13].attribute.start);
...
void RoverExample_Components_Controller_eqFunction_38(DATA *data, threadData_t *threadData)
{
  ...
  if(data->simulationInfo->discreteCall == 1)
  {
    ...
    {
      (data->localData[0]->integerVars[data->simulationInfo->integerVarsIndex[1]] /* pwm_throttle DISCRETE */) = ((modelica_integer) 1000) + ((modelica_integer)floor(DIVISION_SIM((1000.0) * ((data->localData[0]->realVars[data->simulationInfo->realVarsIndex[26]] /* v DISCRETE */)),(data->simulationInfo->realParameter[data->simulationInfo->realParamsIndex[7]] /* v_max PARAM */),"v_max",equationIndexes)));

      (data->localData[0]->integerVars[data->simulationInfo->integerVarsIndex[0]] /* pwm_steering DISCRETE */) = ((modelica_integer) 1500) + ((modelica_integer)floor(DIVISION_SIM((500.0) * ((data->localData[0]->realVars[data->simulationInfo->realVarsIndex[15]] /* delta DISCRETE */)),(data->simulationInfo->realParameter[data->simulationInfo->realParamsIndex[2]] /* delta_max PARAM */),"delta_max",equationIndexes)));
      ...
      if((((data->localData[0]->integerVars[data->simulationInfo->integerVarsIndex[2]] /* s DISCRETE */) == ((modelica_integer) 0)) && tmp8))
      {
        ...
        (data->localData[0]->realVars[data->simulationInfo->realVarsIndex[26]] /* v DISCRETE */) = (data->simulationInfo->realParameter[data->simulationInfo->realParamsIndex[6]] /* v_fwd PARAM */);
      ...
      else
      {
        ...
        else
        {
          ...
          if((((data->localData[0]->integerVars[data->simulationInfo->integerVarsIndex[2]] /* s DISCRETE */) == ((modelica_integer) 1)) && tmp10))
          {
            ...
            (data->localData[0]->realVars[data->simulationInfo->realVarsIndex[15]] /* delta DISCRETE */) = (data->simulationInfo->realParameter[data->simulationInfo->realParamsIndex[3]] /* delta_turn PARAM */);
          }
          else
          {
            ...
            {
              tmp12 = Greater((data->localData[0]->realVars[data->simulationInfo->realVarsIndex[19]] /* psi_change DISCRETE */),(data->simulationInfo->realParameter[data->simulationInfo->realParamsIndex[5]] /* turn_angle PARAM */));
              ...
              {
                tmp13 = Less((data->localData[0]->realVars[data->simulationInfo->realVarsIndex[19]] /* psi_change DISCRETE */),(-(data->simulationInfo->realParameter[data->simulationInfo->realParamsIndex[5]] /* turn_angle PARAM */)));
...
struct OpenModelicaGeneratedFunctionCallbacks RoverExample_Components_Controller_callback = {
  ...
  RoverExample_Components_Controller_getInputVarIndicesInOptimization,
...
void RoverExample_Components_Controller_setupDataStruc(DATA *data, threadData_t *threadData)
{
  ...
  data->modelData->modelGUID = "{efa170bd-cd14-44ca-aee8-ee050d2b5ad5}";
  ...
  data->modelData->nAliasRealArray = 14;
