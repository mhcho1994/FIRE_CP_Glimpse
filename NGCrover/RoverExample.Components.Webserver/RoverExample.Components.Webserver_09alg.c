...
int RoverExample_Components_Webserver_functionAlgebraics(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  ...
  RoverExample_Components_Webserver_function_savePreSynchronous(data, threadData);
