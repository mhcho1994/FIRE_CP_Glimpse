"""
cp_glimpse_py.translator.fmu.to_fmu
=================================
...
class FMUArtifact:
    ...
    source : str
        ...
        obtained. Examples:
        - "translator.fmu.to_fmu.reuse_existing_fmu"
        - "translator.fmu.to_fmu.build_fmu_from_modelica"
    """
...
def _reuse_existing_fmu(
    *,
    ...
    return FMUArtifact(
        ...
        key=key,
        source="translator.fmu.to_fmu.reuse_existing_fmu",
    )
    ...
    *,
    ...
    if expected.exists():
        ...
        return FMUArtifact(
            ...
            work_dir=out_dir,
            key=key,
            source="translator.fmu.to_fmu.build_fmu_from_modelica",
        )
    ...
    build_info: dict[str, object] = {
        ...
        "translator_backend": "translator.fmu.to_fmu.build_fmu_from_modelica",
    }
