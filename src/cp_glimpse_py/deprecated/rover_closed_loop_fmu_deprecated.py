...
from .fmu_wrapper import FMUWrapper
from .fmu_wrapper_cs import FMUWrapperCS
...
def run_rover_closed_loop_fmu(*, scn: dict) -> pd.DataFrame:
    ...
    fmu_type = sim.get("fmu_type", "me") # set default to be ME for now since CS has some issues; can be overridden by scenario config
